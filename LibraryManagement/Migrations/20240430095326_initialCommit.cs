        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BorrowHistories_Books_FkBookId",
                        column: x => x.FkBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowHistories_Customers_FkCustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowHistories_FkBookId",
                table: "BorrowHistories",
                column: "FkBookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowHistories_FkCustomerId",
                table: "BorrowHistories",
                column: "FkCustomerId");
        }
